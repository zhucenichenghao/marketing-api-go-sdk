...
type MaterialAiAnnotationApiService service

/*
MaterialAiAnnotationApiService 素材标注
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return MaterialAiAnnotationAddResponse
*/
func (a *MaterialAiAnnotationApiService) Add(ctx context.Context, data MaterialAiAnnotationAddRequest) (MaterialAiAnnotationAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MaterialAiAnnotationAddResponseData
		localVarResponse    MaterialAiAnnotationAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/material_ai_annotation/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MaterialAiAnnotationAddResponse
