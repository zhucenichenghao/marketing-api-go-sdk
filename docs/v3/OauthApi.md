...
[**OauthRefreshToken**](OauthApi.md#OauthRefreshToken) | **Get** /oauth/refresh_token | 刷新 Refresh Token
...
# **OauthRefreshToken**
> OauthRefreshTokenResponse OauthRefreshToken(ctx, clientId, clientSecret, refreshToken, optional)
刷新 Refresh Token
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  ...
  **clientSecret** | **string**|  | 
  **refreshToken** | **string**|  | 
 **optional** | ***OauthApiOauthRefreshTokenOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a OauthApiOauthRefreshTokenOpts struct
...
[**OauthRefreshTokenResponse**](OauthRefreshTokenResponse.md)
